$vms = Import-Csv  "D:\UserData\Ibraaheem\Scripts\VMWare\DRScripts\6. Uninventory_BDC\vms.csv"
...
foreach($vm in $vms)
 { 
    ...
    $vmoutput | Export-Excel -path "D:\UserData\Ibraaheem\Scripts\VMWare\DRScripts\7. Inventory_CDC\toInventoryCDC.xlsx" -Append
